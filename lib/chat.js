...
export async function chatTurn({
  ...
  appKey,
  apiKey,
  // Verified Supabase user id (server.js's authenticateRequest()), or null
  // for an anonymous request — accounts are entirely optional, chat works
  // identically either way. Accepted here now; not yet acted on (see
  // "compounding study memory" work: auto-logging gathered passages and
  // the search_study_history tool both key off this once it lands).
  userId = null,
