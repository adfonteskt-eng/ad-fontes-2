...
import { appendToConversation, getPaidProfile, logStudyEntry, searchMyNotes, searchStudyHistory } from "./supabase.js";
...
function buildSystemPrompt(hasUser, isPaid, agentName = null) {
...
export async function chatTurn({
  ...
  const { isPaid, agentName: rawAgentName } = hasUser
    ? await getPaidProfile(userId)
    : { isPaid: false, agentName: null };
  ...
  const system = buildSystemPrompt(hasUser, isPaid, agentName);
