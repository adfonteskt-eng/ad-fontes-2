...
export const READING_PLANS = [
  ...
  {
    id: "the-lords-prayer",
    title: "The Lord's Prayer, Line by Line",
    description: "Five days, five lines of the prayer Jesus taught his disciples — slow enough to actually sit with each request.",
    days: [
      { day: 1, usfm: "MAT.6.9", label: "Matthew 6:9", tag: "Our Father in heaven — the address itself is the first lesson." },
      { day: 2, usfm: "MAT.6.10", label: "Matthew 6:10", tag: "Your kingdom come, your will be done — praying for something bigger than your own day." },
      { day: 3, usfm: "MAT.6.11", label: "Matthew 6:11", tag: "Give us this day our daily bread — asking for today, not next year." },
      { day: 4, usfm: "MAT.6.12", label: "Matthew 6:12", tag: "Forgive us, as we forgive — the one line with a condition built in." },
      { day: 5, usfm: "MAT.6.13", label: "Matthew 6:13", tag: "Lead us not into temptation — the prayer ends asking for protection, not just provision." },
    ],
  },
  {
    id: "proverbs-for-the-everyday",
    title: "Proverbs for the Everyday",
    description: "Six short, sharp lines of wisdom about trust, work, words, and money — the kind of thing worth actually memorizing.",
    days: [
      { day: 1, usfm: "PRO.3.5", label: "Proverbs 3:5", tag: "Trust in the Lord with all your heart, not your own understanding." },
      { day: 2, usfm: "PRO.16.3", label: "Proverbs 16:3", tag: "Commit your work to the Lord, and your plans will be established." },
      { day: 3, usfm: "PRO.16.9", label: "Proverbs 16:9", tag: "A man plans his way, but the Lord establishes his steps." },
      { day: 4, usfm: "PRO.27.17", label: "Proverbs 27:17", tag: "Iron sharpens iron — the case for real friendship." },
      { day: 5, usfm: "PRO.15.1", label: "Proverbs 15:1", tag: "A soft answer turns away wrath." },
      { day: 6, usfm: "PRO.3.9", label: "Proverbs 3:9", tag: "Honor the Lord with your wealth — worship that shows up in the budget." },
    ],
  },
  {
    id: "suffering-and-hope",
    title: "Suffering and Hope",
    description: "Six passages that don't rush past real pain on the way to a tidy conclusion — for whenever that's where you actually are.",
    days: [
      { day: 1, usfm: "ROM.5.3", label: "Romans 5:3", tag: "We rejoice in our sufferings — Paul's genuinely strange starting point." },
      { day: 2, usfm: "JAS.1.2", label: "James 1:2", tag: "Count it all joy when you meet trials — an instruction, not a feeling that just arrives." },
      { day: 3, usfm: "2CO.4.17", label: "2 Corinthians 4:17", tag: "A light, momentary affliction — Paul's own word for what didn't feel light at all." },
      { day: 4, usfm: "PSA.34.18", label: "Psalm 34:18", tag: "The Lord is near to the brokenhearted." },
      { day: 5, usfm: "ROM.8.28", label: "Romans 8:28", tag: "All things work together for good — often quoted, easy to misuse if read too fast." },
      { day: 6, usfm: "REV.21.4", label: "Revelation 21:4", tag: "He will wipe away every tear — where the whole story is actually headed." },
    ],
  },
  {
    id: "a-short-course-on-prayer",
    title: "A Short Course on Prayer",
    description: "Six passages on what prayer actually is and how to keep doing it — for when your own words have run out.",
    days: [
      { day: 1, usfm: "PSA.86.11", label: "Psalm 86:11", tag: "Teach me your way, O Lord — starting a prayer by asking how to pray." },
      { day: 2, usfm: "LUK.11.1", label: "Luke 11:1", tag: "Lord, teach us to pray — the question a disciple actually asked." },
      { day: 3, usfm: "1TH.5.17", label: "1 Thessalonians 5:17", tag: "Pray without ceasing — three words, a lifetime of unpacking." },
      { day: 4, usfm: "ROM.8.26", label: "Romans 8:26", tag: "The Spirit helps us in our weakness, when we don't know what to pray." },
      { day: 5, usfm: "JHN.15.7", label: "John 15:7", tag: "Abide in me — prayer as an overflow of staying close, not a formula." },
      { day: 6, usfm: "MAT.7.7", label: "Matthew 7:7", tag: "Ask, and it will be given to you." },
    ],
  },
];
